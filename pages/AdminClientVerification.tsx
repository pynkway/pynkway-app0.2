...
import {
  ShieldCheck, Search, CheckCircle2, XCircle, Clock, Eye,
  ChevronDown, User, FileText, Camera,
} from "lucide-react";
...
const mockRequests: ClientVerificationRequest[] = [
  {
    id: "c1", name: "Max K.", email: "max@example.com", submittedAt: "2026-02-20",
    status: "pending", currentLevel: "basic",
    documents: [
  ...
  {
    id: "c2", name: "Thomas W.", email: "thomas@example.com", submittedAt: "2026-02-19",
    status: "pending", currentLevel: "basic",
    documents: [
      { type: "ID Document", uploaded: true },
  ...
  {
    id: "c3", name: "Stefan M.", email: "stefan@example.com", submittedAt: "2026-02-18",
    status: "approved", currentLevel: "id_verified",
    documents: [
      { type: "ID Document", uploaded: true },
      { type: "Selfie with ID", uploaded: true },
    ],
  ...
  {
    id: "c4", name: "Chris B.", email: "chris@example.com", submittedAt: "2026-02-17",
    status: "rejected", currentLevel: "basic",
    documents: [
      { type: "ID Document", uploaded: true },
      { type: "Selfie with ID", uploaded: false },
    ],
      ...
      <div className="pt-24 pb-12 max-w-4xl mx-auto px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="font-display text-2xl font-bold">Client ID Verification</h1>
              <p className="text-muted-foreground text-sm">Review and manage client identity verification</p>
            </div>
          </div>
        </motion.div>
                  ...
                  <CardContent className="p-4">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground">{req.email} · {req.submittedAt} · Level: {req.currentLevel}</p>
                      </div>
